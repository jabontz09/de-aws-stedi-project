...
inner join customer_trusted c
    on l.user = c.email
'''
SQLQuery_node1754615206593 = sparkSqlQuery(glueContext, query = SqlQuery5191, mapping = {"customer_trusted":AWSGlueDataCatalog_node1754614935956, "accelerometer_landing":AmazonS3_node1754614887895}, transformation_ctx = "SQLQuery_node1754615206593")
...
AmazonS3_node1754615020034 = glueContext.getSink(path="s3://jb-testspark/accelerometer/trusted/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="AmazonS3_node1754615020034")
AmazonS3_node1754615020034.setCatalogInfo(catalogDatabase="stedi_db",catalogTableName="accelerometer_trusted")
